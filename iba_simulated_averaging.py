...
if __name__ == "__main__":
    ...
    parser.add_argument('--defense_method', type=str, default="no-defense",
                        help='defense method used: no-defense|norm-clipping|norm-clipping-adaptive|weak-dp|krum|multi-krum|rfa|crfl|rlr|foolsgold|nofca')
    parser.add_argument('--mask_ratio', type=float, default=0.3,
                        help='mask ratio to use')
    parser.add_argument('--device', type=str, default='cuda',
                        help='device to set, can take the value of: cuda or cuda:x')
    parser.add_argument('--attack_method', type=str, default="dimension",
                        help='describe the attack type: blackbox|pgd|graybox|dimension')
    ...
    parser.add_argument('--norm_bound', type=float, default=3,
                        help='describe if there is defense method: no-defense|norm-clipping|weak-dp|nofca')
